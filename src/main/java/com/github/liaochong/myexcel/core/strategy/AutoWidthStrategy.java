...
public enum AutoWidthStrategy {
    ...
    public static boolean isComponentAutoWidth(AutoWidthStrategy autoWidthStrategy) {
        return Objects.equals(autoWidthStrategy, COMPONENT_AUTO_WIDTH);
    }
}
